    ...
    const handleAddSub = () => {
        ...
        clientRef.current.subscribe(newSubTopic.trim(), { qos: newSubQoS }, (err) => {
            if (!err) {
                const time = new Date().toLocaleTimeString();
                setSubLogs((prev) => [
                    { time, topic: newSubTopic.trim(), payload: t('websocket.subscribed'), qos: newSubQoS },
                    ...prev,
                ]);
            }
        });
                    ...
                    icon={
                        <Box
                            sx={{
                                ...
                                height: 8,
                                borderRadius: '50%',
                                bgcolor: connected ? '#22C55E' : '#64748B',
                                ml: 1,
                            }}
                        />
                    }
                    ...
                    <Box sx={{ ...cardSx, height: '100%', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 2 }}>
                            <TextField
                                size="small"
                                select
                                label={t('websocket.qos')}
                                value={pubQoS}
                                onChange={(e) => setPubQoS(Number(e.target.value) as QoS)}
                                sx={{ width: 80 }}
                                disabled={!connected}
                            >
                        ...
                        <Typography
                            variant="overline"
                            sx={{ mb: 1, display: 'block', color: 'text.secondary', fontSize: '0.65rem' }}
                        >
                    ...
                    <Box sx={{ ...cardSx, height: '100%', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <Stack direction="row" spacing={1} sx={{ mb: 2 }}>
                            ...
                            <TextField
                                ...
                                select
                                value={newSubQoS}
                                onChange={(e) => setNewSubQoS(Number(e.target.value) as QoS)}
                        ...
                        <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 1 }}>
                            ...
                            <Button
                                ...
                                onClick={() => setSubLogs([])}
                                size="small"
                                sx={{ fontSize: '0.7rem', minWidth: 'auto', color: 'text.secondary' }}
                            >
                                {t('websocket.clear')}
                            </Button>
                        </Stack>
