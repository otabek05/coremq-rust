...
export function SessionView() {
  ...
  const subscriptionEntries = selected
    ? Object.entries(selected.subscriptions)
    : [];
            ...
            <Table size="small">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="right" sx={{ width: 100 }}>{t("sessions.actions")}</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {sessions.map((session, index) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Typography variant="subtitle2" sx={{ fontFamily: 'JetBrains Mono Variable', fontSize: '0.8rem' }}>
                        {session.client_id}
                      </Typography>
                    </TableCell>
                    <TableCell>{session.username || <Typography variant="caption" sx={{ color: 'text.secondary' }}>--</Typography>}</TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Chip
                        ...
                        size="small"
                        variant="outlined"
                        sx={{ fontFamily: 'JetBrains Mono Variable', fontSize: '0.75rem', borderColor: 'rgba(148,163,184,0.15)' }}
                      />
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Chip
                        ...
                        size="small"
                        color={Object.keys(session.subscriptions).length > 0 ? "primary" : "default"}
                        variant="filled"
